...
class UserControllerTest {
    ...
    public void testGetUserById_Success() throws Exception {
        var responseFromService = UserDto.builder().id(1L).username("user").email("1234@mai.com").username("user").password("1234").build();
    ...
    public void testUpdate_Success() throws Exception {
        var actualRecord = UserDto
                ...
                .password("1234")
                .build();
        var responseFromService = UserDto
                .builder()
                .id(1L)
                .username("user 2")
                .email("12345@mai.com")
        ...
        when(userService.update(actualRecord)).thenReturn(responseFromService);
        ...
        verify(userService, Mockito.times(1)).update(actualRecord);
    }
